...
<%
    ...
    String sql = "select * from account where account_id = "+ user_id;
    ...
    String price = rs.getString("movie_price");
    String year = rs.getString("movie_year");
    String rentCount = rs.getString("movie_rentCount");
    String imageUrl = rs.getString("movie_imgPath");
    String rate = rs.getString("movie_rate");
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="index_2.jsp"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
                        </li>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    <form role="form" action="/IA_ALi/EditMovie"  method="post">
                                        ...
                                        <div class="form-group">
                                            <label>year</label>
                                            <input class="form-control" value="<%= year %>" year>
                                        </div>
